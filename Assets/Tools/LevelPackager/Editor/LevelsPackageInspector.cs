...
namespace Dwipantara.LevelPackager {
	...
	public class LevelsPackageInspector : Editor {
		...
		private void DrawElement (Rect rect, int index, bool active, bool focused) {
			...
			item.scene = EditorGUI.TextField (new Rect (rect.x + rect.width * 0.52f, rect.y, rect.width - rect.width * 0.52f, rect.height), item.scene);
