...
public class InputWrapper : MonoBehaviour {
	...
	public bool VirtualAttack {
		get { return _virtualAttack; }
		set { _virtualAttack = value; }
	}
	...
	public bool GetAttack() {
		bool result = _enabled && ((Input.GetKeyDown (KeyCode.RightControl) || _virtualAttack));
		_virtualAttack = false; // This force to release the button
		return result;
	}
