...
public class topikkuis : MonoBehaviour
{
    ...
    {
        Sistema.instancia.BotaoSom();
        Sistema.instancia.SetNomeTema("Bagian Papua");
	...
	{
		Sistema.instancia.BotaoSom();
		Sistema.instancia.SetNomeTema("Bagian Maluku");
	...
	public void AddBio()
	{
		...
		Sistema.instancia.SetNomeTema("Bagian Sulawesi Tengah");
		SceneManager.LoadScene("PreAll");
	}
		
    public void AddBagian4()
    {
        Sistema.instancia.BotaoSom();
		AddPerguntas.Add_bagian4();
        Sistema.instancia.SetNomeTema("Bagian Kalimantan Barat");
        SceneManager.LoadScene("PreAll");
    }
