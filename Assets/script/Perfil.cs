...
public class Perfil : MonoBehaviour
{
    ...
    public void DeletarConta()
    {
        try
        {
            ...
            if (confirm.Equals("") || !confirm.Equals("DELETE"))
            {
                up.Blend("Error");
                up.Blend("Error1");
            }
            else
            {
				...
				PlayerPrefs.DeleteKey("PapuaScore");
				PlayerPrefs.DeleteKey("MalukuScore");
				PlayerPrefs.DeleteKey("SulawesiScore");
				PlayerPrefs.DeleteKey("KalimantanScore");
